...
namespace AcadScript
{
    ...
    public class QueueLinearFloodFiller : AbstractFloodFiller
    {
        ...
        {
            results = new List<System.Drawing.Point>();
            watch.Reset();
            watch.Start();
            ...
            startColor = new byte[] { bitmapBits[idx], bitmapBits[idx + 1], bitmapBits[idx + 2] };
       ...
       void LinearFill(ref int x, ref int y)
        {
           ...
           int bitmapWidth=this.bitmapWidth;
            ...
            while (true)
            {
                ...
                results.Add(new System.Drawing.Point(rFillLoc, y ));
                //**indicate that this pixel has already been checked and filled
                pixelsChecked[pxIdx] = true;
                //**screen update for 'slow' fill
